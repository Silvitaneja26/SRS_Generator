...
var projectName="devina";
document.getElementById('const1').innerHTML=projectName;
function store()
{
    ...
    document.getElementById("companyName").innerHTML=organizationName;
    //var projectName=document.getElementById("projectName").value;
    ...
    //document.getElementById("hi").innerHTML= "Organization of the software project: "+organizationName;
}
